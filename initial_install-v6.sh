...
OSHI_VM_DESKTOP_FILE_NAME="OSHI_VM_12"
...
# (START) in this version IPRoute2 is not reinstalled
if false; then
...
# (END) in this version IPRoute2 is not reinstalled
...
# (START) in this version OpenVSwitch is not reinstalled
if false; then
...
# (END) in this version OpenVSwitch is not reinstalled
...
echo -e "\n\n#####################################"
echo -e "\n-Re-installing dependencies to run Ryu as root"
#this is needed in the OSHI use case when running Ryu as root from the controller in Mininet
...
sudo cp $WORKSPACE_DIR/Mantoo-scripts-and-readme/VM-Desktop/xubuntu-quantal-oshi-rdcl3d.png /usr/share/xfce4/backdrops
